...
class Context(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        self.axis = np.array([
            (
                'X линейное', 'axis_x_L', int(AXIS_L_X), 0, 0, 0, 0, "x_p.png", "x_m.png", "t_l_x_p", "t_l_x_m", None,
                None,
                1, 1, -1, 0),
            (
                'Y линейное', 'axis_y_L', int(AXIS_L_Y), 0, 0, 0, 0, "y_p.png", "y_m.png", "t_l_y_p", "t_l_y_m", None,
                None,
                1, -1, 1, 0),
            (
                'Z линейное', 'axis_z_L', int(AXIS_L_Z), 0, 0, 0, 0, "z_p.png", "z_m.png", "t_l_z_p", "t_l_z_m", None,
                None,
                1, 1, -1, 0),
            ('X вращение', 'axis_rx_L', int(AXIS_L_R_X), 0, 0, 0, 0, "x_cw.png", "x_ccw.png", "t_l_x_cw", "t_l_x_ccw",
             None, None, 1, -1, 1, 0),
            ('Y вращение', 'axis_ry_L', int(AXIS_L_R_Y), 0, 0, 0, 0, "y_cw.png", "y_ccw.png", "t_l_y_cw", "t_l_y_ccw",
             None, None, 1, 1, -1, 0),
            ('Z вращение', 'axis_rz_L', int(AXIS_L_R_Z), 0, 0, 0, 0, "z_cw.png", "z_ccw.png", "t_l_z_cw", "t_l_z_ccw",
             None, None, 1, -1, 1, 0),
            (
                'X линейное', 'axis_x_R', int(AXIS_R_X), 0, 0, 0, 0, "x_p.png", "x_m.png", "t_r_x_p", "t_r_x_m", None,
                None,
                1, -1, 1, 1),
            (
                'Y линейное', 'axis_y_R', int(AXIS_R_Y), 0, 0, 0, 0, "y_p.png", "y_m.png", "t_r_y_p", "t_r_y_m", None,
                None,
                1, -1, 1, 1),
            (
                'Z линейное', 'axis_z_R', int(AXIS_R_Z), 0, 0, 0, 0, "z_p.png", "z_m.png", "t_r_z_p", "t_r_z_m", None,
                None,
                1, 1, -1, 1),
            ('X вращение', 'axis_rx_R', int(AXIS_R_R_X), 0, 0, 0, 0, "x_cw.png", "x_ccw.png", "t_r_x_cw", "t_r_x_ccw",
             None, None, 1, 1, -1, 1),
            ('Y вращение', 'axis_ry_R', int(AXIS_R_R_Y), 0, 0, 0, 0, "y_cw.png", "y_ccw.png", "t_r_y_cw", "t_r_y_ccw",
             None, None, 1, -1, 1, 1),
            ('Z вращение', 'axis_rz_R', int(AXIS_R_R_Z), 0, 0, 0, 0, "z_cw.png", "z_ccw.png", "t_r_z_cw", "t_r_z_ccw",
             None, None, 1, 1, -1, 1),
            ('Y стол', 'axis_y_T', int(AXIS_TABLE), 0, 0, 0, 0, "y_p.png", "y_m.png", "t_t_y_p", "t_t_y_m", None, None,
             2, 1, -1, 2)],
        ...
        self.auto_meas_pm1 = True
        self.auto_meas_pm2 = True
        self.auto_meas_pm3 = True
